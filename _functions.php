...
use Bitka\Woo;
use Bitka\WooTax;
use Bitka\WooShipping;
use Bitka\WooTabs;  
use Bitka\Core\Dashboard;

// Klassen einbinden
#include_once __DIR__ . '/inc/Theme.php';
// include_once __DIR__ . '/inc/Woo.php';
// include_once __DIR__ . '/inc/WooTax.php';
// include_once __DIR__ . '/inc/WooShipping.php';
// include_once __DIR__ . '/inc/WooTabs.php';
// include_once __DIR__ . '/inc/core/Dashboard.php';
